...
class mamba(bb_base, hpccm.templates.rm, hpccm.templates.wget):
    ...
    def __cpu_arch(self):
        ...
        # Linux macOS Intel/AMD x86_64
        elif hpccm.config.g_cpu_arch == cpu_arch.MACOSX86_64:
            self.__arch_pkg = 'osx-64'

        # Linux macOS Silicon/M1 ARM64
        elif hpccm.config.g_cpu_arch == cpu_arch.MACOSAARCH64:
            self.__arch_pkg = 'osx-arm64'
